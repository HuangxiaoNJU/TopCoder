...
// CUT begin
	...
	static void runTest(HashSet<Integer> caseSet) {
	    ...
	    while (true) {
            ...
            int[] sections = new int[Integer.parseInt(Reader.nextLine())];
            for (int i = 0; i < sections.length; ++i)
                sections[i] = Integer.parseInt(Reader.nextLine());
            Reader.nextLine();
	...
	static class Reader {
        private static final String dataFileName = "GoldenChain.sample";
